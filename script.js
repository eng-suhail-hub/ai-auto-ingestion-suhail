...
async function testConnection(){
  ...
  try{
    // Use a slightly larger image for test connection as some providers reject tiny ones
    const c=document.createElement('canvas'); c.width=64; c.height=64;
    const ctx=c.getContext('2d');
    ctx.fillStyle='#5b4af8'; ctx.fillRect(0,0,64,64);
    ctx.fillStyle='#ffffff'; ctx.font='bold 10px sans-serif'; ctx.fillText('TEST', 18, 36);
